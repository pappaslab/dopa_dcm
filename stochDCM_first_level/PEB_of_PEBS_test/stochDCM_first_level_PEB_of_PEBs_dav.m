...
%% Directories
dcmbase = '/home/despoC/dvogel/rsfMRI_DA_Hierarchy/rsfMRI_DA_Analysis_DAVID/fMRIprep/DA_team_rsfMRI/stochDCM/PEB_of_PEBs';
...
%         dcm.a = model; 
        for s = 1:length(session)
            ...
            sub_base = ([dcmbase, '/sub-', sub, '/session-', cond, '/']); 
