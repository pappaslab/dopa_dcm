...
DCMa.models{7} = [1 1 1; 1 1 1; 1 1 1];
DCMa.models{8} = [1 0 0; 1 1 0; 0 1 1];
DCMa.models{9} = [1 1 0; 1 1 1; 0 1 1];
DCMa.models{10} = [1 0 0; 1 1 0; 1 1 1];
DCMa.models{11} = [1 1 0; 0 1 1; 0 0 1];
DCMa.models{12} = [1 1 1; 0 1 1; 0 0 1];
DCMa.models{13} = [1 1 1; 1 1 1; 1 1 1];
DCMa.models{14} = [1 0 0; 1 1 0; 0 1 1];
DCMa.models{15} = [1 1 0; 1 1 1; 0 1 1];
DCMa.models{16} = [1 0 0; 1 1 0; 1 1 1];
DCMa.models{17} = [1 1 0; 0 1 1; 0 0 1];
DCMa.models{18} = [1 1 1; 0 1 1; 0 0 1];
...
DCMb.models{7} = [0 1 1; 1 0 1; 1 1 0];
DCMb.models{8} = [0 0 0; 1 0 0; 0 1 0];
DCMb.models{9} = [0 1 0; 1 0 1; 0 1 0];
DCMb.models{10} = [0 0 0; 1 0 0; 1 1 0];
DCMb.models{11} = [0 1 0; 0 0 1; 0 0 0];
DCMb.models{12} = [0 1 1; 0 0 1; 0 0 0];
DCMb.models{13} = [0 0 0; 0 0 0; 0 0 0];
DCMb.models{14} = [0 0 0; 0 0 0; 0 0 0];
DCMb.models{15} = [0 0 0; 0 0 0; 0 0 0];
DCMb.models{16} = [0 0 0; 0 0 0; 0 0 0];
DCMb.models{17} = [0 0 0; 0 0 0; 0 0 0];
DCMb.models{18} = [0 0 0; 0 0 0; 0 0 0];
